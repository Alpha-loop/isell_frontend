    ...
    <div className="w-full max-w-full box-border overflow-x-hidden">
      ...
      <div className="p-3 sm:p-6 w-full max-w-full box-border">
        ...
        <p className="text-gray-700 text-sm sm:text-base">
          Track your shipment status, share updates with friends,<br /> and discover local pickup options.
        </p>

        <div className="sm:p-6 rounded-lg mb-6 sm:mb-8 w-115 box-border mt-5">
          <div className="relative">
            <input
              type="text"
              placeholder="Track product name/ID here"
              className="pl-10 pr-4 py-2 sm:py-3 border border-gray-300 rounded-4xl w-full max-w-full focus:outline-none focus:ring-2 focus:ring-blue-500 h-15 bg-gray-100"
            />
            <svg
